...
import './draw-connector.scss';

const DrawConnector = (props) => {
    ...
    return (
        <div>
            <svg className="draw-connector"
                style={{ position: "absolute", top: 0, left: 0, pointerEvents: "none" }}
                width="100%"
                height="100%"
                draggable={false}>

                <line draggable={false} x1={linePos.x1} y1={linePos.y1} x2={linePos.x2} y2={linePos.y2} strokeWidth="2px" stroke="white" />
            </svg>
        </div>
    )
}

DrawConnector.defaultProps = {
